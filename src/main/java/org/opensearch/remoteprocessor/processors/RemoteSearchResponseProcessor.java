...
public class RemoteSearchResponseProcessor extends AbstractProcessor implements SearchResponseProcessor {
    ...
    public void processResponseAsync(SearchRequest request, SearchResponse response, PipelineProcessingContext ctx, ActionListener<SearchResponse> listener) {
        ...
        HttpRequest httprequest = buildRequest(request, response, ctx);
        sendRequest(httprequest, ActionListener.wrap(
            httpresponse -> {
                listener.onResponse(parseResponse(httpresponse));
            },
            e -> {
    ...
    private HttpRequest buildRequest(SearchRequest request, SearchResponse response, PipelineProcessingContext ctx) {
        throw new UnsupportedOperationException("Not yet implpemented");
    }

    private void sendRequest(HttpRequest request, ActionListener<HttpResponse> listener) {
        throw new UnsupportedOperationException("Not yet implemented");
    }

    private SearchResponse parseResponse(HttpResponse response) {
        throw new UnsupportedOperationException("Not yet implemented");
    }
